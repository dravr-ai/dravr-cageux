...
pub trait ActivityAnalyzerTrait {
    ...
    async fn analyze_activity(&self, activity: &Activity) -> IntelligenceResult<ActivityInsights>;
    ...
    async fn detect_anomalies(&self, activity: &Activity) -> IntelligenceResult<Vec<Anomaly>>;
    ...
    async fn calculate_training_load(&self, activity: &Activity) -> IntelligenceResult<f64>;
    ...
    ) -> IntelligenceResult<Vec<AdvancedInsight>>;
}
...
impl ActivityAnalyzerTrait for AdvancedActivityAnalyzer {
    ...
    async fn analyze_activity(&self, activity: &Activity) -> IntelligenceResult<ActivityInsights> {
        ...
        let metrics = self
            ...
            .map_err(|e| IntelligenceError::internal(format!("Metrics calculation failed: {e}")))?;
        ...
        let anomalies = self
            ...
            .await
            .map_err(|e| IntelligenceError::internal(format!("Anomaly detection failed: {e}")))?;
