...
//!
//! This module is the single source of the three deserializers: the kernel
//! reads [`WorkoutStep`](crate::periodization::WorkoutStep) through `whole_u32`, and the
//! platform imports `whole_u8` / `whole_u32_opt` from here for its
//! training-plan payloads rather than carrying a copy.
